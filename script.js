...
function animateLeft(element) {
    if (!element) throw new Error('The element should be passed to that function!');
    var interval = setInterval(function () {
        moveLeft(element, 25);
        if (trimPx(element.style.left) < (325 - div.offsetWidth)) {
...
var div = document.querySelector('.fries');
var divX = 1500;
var divY = 600;
var step = 50;
